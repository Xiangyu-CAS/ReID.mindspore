...
class Encoder(nn.Cell):
    def __init__(self):
        ...
        self.base, self.in_planes = resnet50(batch_size=32, num_classes=1), 2048
        self.gap = ops.ReduceMean(keep_dims=True)
...
class Head(nn.Cell):
    def __init__(self, encoder, num_class):
        ...
        # TODO: circle loss
        self.classifier = fc_with_initialize(self.encoder.in_planes, num_class)
